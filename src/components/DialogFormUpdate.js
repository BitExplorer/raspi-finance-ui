...
//TODO: cleared value
    ...
    if (
      accountNameOwner.textContent !== 'account name owner...' &&
  ...
  componentDidMount() {
    ...
    //MenuItem vs option
    this.props.accountNameOwnerList.forEach(element1 => {
      accountNameOwnerJoinedList = accountNameOwnerJoinedList.concat({
        value: element1.accountNameOwner,
        label: element1.accountNameOwner,
      });
    });

    clearedList.forEach(element1 => {
      clearedJoinedList = clearedJoinedList.concat({
        value: element1,
        label: element1,
      });
    });
    ...
    this.setState({
      accountNameOwnerOptions: accountNameOwnerJoinedList,
      clearedOptions: clearedJoinedList,
    });
    //let accountNameOwner = document.getElementById('accountNameOwner')
  }
          ...
          <DialogContent>
            ...
            <div>
              <Select
                ...
                onChange={this.handleAccountNameOwnerChange}
                options={this.state.accountNameOwnerOptions}
              />
              ...
              <Select
                autoFocus
                label="Cleared"
                placeholder="transaction cleared..."
                id="cleared"
                key="cleared"
                useDefault={true}
                defaultValue={transaction.cleared}
                margin="dense"
                onChange={this.handleClearedChange}
                options={this.state.clearedOptions}
              />
              <TextField
                autoFocus
                label="Notes"
